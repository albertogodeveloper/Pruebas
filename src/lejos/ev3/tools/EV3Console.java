...
/**
 * Console output monitor class. This class provides access to console output
 * from a NXT program. The program simply writes strings using the NXT RConsole
 * class. These are sent to the PC via the USB (or Bluetooth) connection.
 *
 */
